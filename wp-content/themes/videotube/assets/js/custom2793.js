(function($) {
	...
	try {
		...
		$('form#wppb-edit-user input[type=text], form#wppb-edit-user input[type=password], form#wppb-edit-user select, form#wppb-edit-user textarea').addClass('form-control form-control-sm');	    
